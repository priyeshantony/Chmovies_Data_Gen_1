...
import { FaChartBar, FaFileAlt, FaUserPlus, FaChevronDown, FaChevronRight, FaUsers, FaFilm, FaCog, FaUsb, FaBorderAll, FaVideo, FaVideoSlash, FaList, FaFileVideo } from "react-icons/fa";
